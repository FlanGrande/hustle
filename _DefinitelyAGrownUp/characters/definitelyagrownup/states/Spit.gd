...
func _frame_0():
	...
	# If using data, it'd be cool to have just the strength of the spit to decide how far it goes, but x: 1.0 & y: 0.0?
	#if data: TO DO: Use data?
...
#	host.update_facing()
	...
	#var dir = xy_to_dir(data.x, data.y) TO DO: Use data?
	var dir = xy_to_dir(1.0, 0)
